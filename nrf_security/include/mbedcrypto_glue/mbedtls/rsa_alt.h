...
#define VANILLA_MBEDTLS_RSA_CONTEXT_WORDS     (43)    //!< Context size in words in vanilla mbed TLS in words.
...
typedef struct mbedtls_rsa_context
{
    ...
    union
    {
        ...
        uint32_t buffer_vanilla_mbedtls[VANILLA_MBEDTLS_RSA_CONTEXT_WORDS];   //!< Array the size of an RSA context in vanilla mbed TLS.
